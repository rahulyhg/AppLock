...
public class AppConstants {
    ...
    public static final String SP_APP_LOCK_CLONE = "sp_app_lock_clone";
    public static final String SP_PATTERN_EXISTS = "sp_patttern_exists";
    public static final String SP_PATTERN = "sp_pattern";
